...
namespace UG.Math2d
{
	public struct Vect
	{
		...
		public static Vect ZERO { get => new Vect(0, 0); }
		///<summary>Unit vector on X coordinate: (1,0)
		///<para>To get negative unit vector, use unary - operator.</para></summary>
		public static Vect UNIT_X { get => new Vect(1, 0); }
		///<summary>Unit vector on Y coordinate: (0,1)
		///<para>To get negative unit vector, use unary - operator.</para></summary>
		public static Vect UNIT_Y { get => new Vect(0, 1); }

		//---------- operator overloads ----------//

		///<summary>Unary - operator: opposite/negative vector. 
		///<para>Both coordinates reversed: (-x,-y)</para></summary>
		public static Vect operator -(Vect a) => new Vect(-a.x, -a.y);

		public static Vect operator +(Vect a, Vect b) => new Vect(a.x + b.x, a.y + b.y);
		public static Vect operator -(Vect a, Vect b) => new Vect(a.x - b.x, a.y - b.y);
		public static Vect operator *(Vect a, double b) => new Vect(a.x * b, a.y * b);
		public static Vect operator *(double a, Vect b) => new Vect(a * b.x, a * b.y);
		public static Vect operator /(Vect a, double b) => new Vect(a.x / b, a.y / b);
		public static Vect operator /(double a, Vect b) => new Vect(a / b.x, a / b.y);
		public static Vect operator %(Vect a, double b) => new Vect(a.x % b, a.y % b);
		public static Vect operator %(double a, Vect b) => new Vect(a % b.x, a % b.y);
